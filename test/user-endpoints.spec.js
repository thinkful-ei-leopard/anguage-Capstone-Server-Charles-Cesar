    ...
    describe(`Given a valid user`, () => {
      ...
      it(`inserts 1 language with words for the new user`, () => {
        ...
        const expectedList = {
          ...
          total_score: 0,
          words: [
            { original: 'proyecto', translation: 'project' },
            { original: 'codigo', translation: 'code' },
            { original: 'computadora', translation: 'computer' },
            { original: 'trabajo', translation: 'work' },
            { original: 'comer', translation: 'eat' },
            { original: 'programacion', translation: 'programming' },
            { original: 'zorro', translation: 'fox' },
            { original: 'verano', translation: 'summer' },
            { original: 'frio', translation: 'cold' },
            { original: 'carro', translation: 'car' },
          ]
        }
        return supertest(app)
          .post('/api/user')
